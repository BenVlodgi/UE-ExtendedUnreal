...
public:
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "Actor", meta = (DefaultToSelf = "Target", ComponentClass = "/Script/Engine.ActorComponent", ComponentName, DeterminesOutputType = "ComponentClass", keywords = "find"))
	static UPARAM(DisplayName = "Components") TArray<UActorComponent*> GetComponentsByClass(AActor* Target, TSubclassOf<UActorComponent> ComponentClass, bool bIncludeChildActors = false);
	...
	UFUNCTION(BlueprintPure, Category = "Actor", meta = (DefaultToSelf = "Actor", DisplayName = "Is Running Construction", keywords = "Is RunningUserConstructionScript"))
