...
public:
	...
	static void SetWorldPartitionStreamingSource_DefaultVisualizerLoadingRange(UWorldPartitionStreamingSourceComponent* StreamingSourceComponent, const float Range);
};
